...
async function cargarGaleria() {
  ...
  try {
    ...
    snap.forEach(doc => {
      ...
      imgEl.src     = d.urlFoto;
      imgEl.alt     = "Fotografía de la comunidad";
      imgEl.loading = "lazy";
      imgEl.addEventListener("click", () => window.abrirLightbox(d.urlFoto, d.descripcion));
 
      const infoEl = document.createElement("div");
      infoEl.className = "galeria-item-info";
      infoEl.innerHTML = `
...
window.abrirLightbox = function(src, desc) {
